...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    infiniteHandler: function infiniteHandler($state) {
      var that = this;
      this.$http.get('/test/vue?page=' + this.page).then(function (response) {
                    ...
                    return _c("p", [
                      _c(
                        "a",
                        {
                          attrs: {
                            href:
                              "https://itsolutionstuff.com/post/" + item.slug,
                            target: "_blank"
                          }
                        },
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "card-header" }, [
      _c("strong", [_vm._v("Load more khi scroll với laravel và vuejs")])
    ])
  }
]
...
__webpack_require__(/*! C:\xampp\htdocs\botble\resources\js\app.js */"./resources/js/app.js");
!(function webpackMissingModule() { var e = new Error("Cannot find module 'C:\\xampp\\htdocs\\botble\\resources\\sass\\app.scss'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
