		    ...
		    <div class="navbar-default sidebar" role="navigation">
			    <div class="sidebar-nav navbar-collapse">
				    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="{{route('tracker.stats.index')}}?page=route" class="{{ Session::get('tracker.stats.page') =='route' ? 'active' : '' }}"><i class="fa fa-rouble fa-fw"></i>@lang("tracker::tracker.route") <span class="{{ Session::get('tracker.stats.page') =='route' ? 'fa arrow' : '' }}"></span></a>
                        </li>
                    </ul>
                    <!-- /#side-menu -->
                </div>
