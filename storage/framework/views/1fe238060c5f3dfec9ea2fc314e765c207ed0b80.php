        ...
        <?php $__currentLoopData = $recent_post; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="media">
                <div class="media-left">
                    <a href="<?php echo e(route('public.blog.details')); ?>/<?php echo e($post->slug ?? ''); ?>"><img class="media-object sidebar-img"
                ...
                <div class="media-body">
                    ...
                    </h3> <span class="media-date"><a href="javascript:;"><?php echo e($post->created_at->toDateString()); ?></a>,  by: <a
                            href="javascript:;"><?php echo e($post->author->first_name); ?></a></span>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\botble\platform\plugins\blog\src\Providers/../../../../themes/general//views/general/most_coment.blade.php ENDPATH**/ ?>