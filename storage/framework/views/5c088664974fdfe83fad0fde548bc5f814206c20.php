        ...
        <div class="row">
            <?php if(!empty($value)): ?>
                <?php $__currentLoopData = $value; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-2 col-sm-3 col-4 photo-gallery-item" data-id="<?php echo e($key); ?>">
...
<?php $__env->stopPush(); ?><?php /**PATH C:\xampp\htdocs\botble\platform\plugins/gallery/resources/views//gallery-box.blade.php ENDPATH**/ ?>