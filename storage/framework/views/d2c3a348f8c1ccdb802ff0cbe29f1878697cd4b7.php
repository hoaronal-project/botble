...
<div class="seo-preview">
    <p class="default-seo-description <?php if(!empty($object)): ?> hidden <?php endif; ?>"><?php echo e(trans('packages/seo-helper::seo-helper.default_description')); ?></p>
    <div class="existed-seo-meta <?php if(empty($object)): ?> hidden <?php endif; ?>">
        <span class="page-title-seo">
             <?php echo e($meta['seo_title'] ?? (!empty($object) ? $object->name ?? $object->title : null)); ?>
        ...
        <div class="page-description-seo ws-nm">
            <?php echo e(strip_tags($meta['seo_description'] ?? (!empty($object) ? $object->description : (!empty($object) && $object->content ? Str::limit($object->content, 250) : old('seo_meta.seo_description'))))); ?>
...
</div><?php /**PATH C:\xampp\htdocs\botble\platform\packages/seo-helper/resources/views//meta_box.blade.php ENDPATH**/ ?>