        ...
        <div class="container">
            <div class="row">
                <div class="footer">
                    ...
                    <div class="col-sm-6">
                        <p>&copy; Copyright <?php echo e(Carbon\Carbon::now()->year); ?>-iSHARE . Design by: <a href="<?php echo e(route('public.index') ?? 'javascript:;'); ?>">iSHARE DESIGN.</a> </p>
                    </div>
                    <div class="col-sm-3">
...
<?php /**PATH C:\xampp\htdocs\botble\platform\themes/general/partials/footer.blade.php ENDPATH**/ ?>